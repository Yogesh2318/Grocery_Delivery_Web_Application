          ...
          <section className="mt-8 grid grid-cols-[250px_1fr_340px] gap-6">
            <aside className="sticky top-8 h-fit rounded-[8px] border border-[#dfe7d9] bg-white p-4 shadow-sm shadow-black/5">
              ...
              <CategoryNav
                ...
                variant="sidebar"
              />
              <div className="mt-5 rounded-[8px] bg-[#fff4cf] p-4">
                <p className="text-sm font-black text-[#17211a]">
                  Filters ready
                </p>
                <p className="mt-2 text-xs leading-5 text-[#745515]">
                  Category, search, and favorites are wired. Price and brand
                  filters can connect to the same store.
                </p>
              </div>
            </aside>
            ...
            <section>
              <div className="mb-4 flex items-end justify-between">
                ...
                <p className="text-sm text-[#657160]">
                  Minimum 4-column desktop product grid
                </p>
              </div>
